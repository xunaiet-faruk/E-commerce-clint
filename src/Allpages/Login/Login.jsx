    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <form onSubmit={handlelogin}>
                ...
                <div className="relative flex   lg:ml-12 mb-10 mt-12 flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
                    ...
                    <div className=" mb-7 flex flex-col justify-center items-center">
                        ...
                        <button onClick={handlegoogle} className="btn w-[200px] font-semibold"> <FcGoogle className="text-2xl"></FcGoogle>Google</button>
                    </div>
                </div>
